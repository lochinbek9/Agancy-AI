...
function ContactUs() {
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "76ed967f-fe8f-46f1-99da-13d065a190b7");
        try{
            const response = await fetch("https://api.web3forms.com/submit", {
              ...
              if (data.success) {
                toast.success("Thank you your submission!");
                event.target.reset();
              } else {
  ...
  return (
    <div id="ourwork" className="flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24  xl:px-40 pt-20 pb-40 text-gray-800 dark:text-white">
